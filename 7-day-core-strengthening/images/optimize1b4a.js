...
"resource": {
  ...
  "macros":[{
      ...
      "function":"__gaoo_c",
      "vtp_trackingId":"UA-165622255-1"
    },{
      "vtp_experimentKey":"OPT-PDS9JV2_OPT-N6L8C",
      "function":"__c",
      "vtp_value":true
    },{
      "function":"__u",
      ...
      "function":"__exs",
      "vtp_measurementId":"qyC6N7XhRZe74v14-Z506A",
      "vtp_sections":["list",2]
    },{
      "vtp_experimentKey":"OPT-PDS9JV2_OPT-N6L8C",
      "function":"__c",
      ...
      "function":"__c",
      "vtp_value":["map","",18576,"wdgyfQP7Rgem0CQNFMTeNQ",0,"4ZnNPgygQUSESccFlGGAqA",0,"5FsgjyPGRIyJRJF38EhB8Q",0,"y1X8r81sRWqCUEM8B_HUyw",0,"LCWWBv4dS9e3MTkPGtpAxA",0,"B_4riLLaQoqqve0UfP7t5g",0,"Nxbws9fIQxWGd_r8duEt-g",0,"PJRr1Ey-Q1OXOENlkw4-Qw",0,"UnXerUQ5Tv61GhPx2ViwiA",0,"f-VedOuLS0Gtwv_j1jEEZQ",0,"vpWqMn1SSKiD6XBsaD59zA",18668,"UHHnDMJDRb6mv3fOY3SC6Q",0,"114GOyddQSmJZOCvULa8Cw",0,"2CSUZJq3QPy8xKtPi-QpNQ",0,"DRBbh8OCTr2HufSI6juysg",0,"GijQolpKSbKK7ezn5BC7dg",0,"tUB_vYwoQiyedbBziwUEYA",0,"qyC6N7XhRZe74v14-Z506A",18665,"JOnYuBLZQaWp41hEtjMNvQ",0,"bSZUFQECSKmPGAZ7gPN7QQ",0,"sVngp7CqQi6q0Ia1Tp8leg",0,"Epb1eAYxTgO1hI21a_vggg",0,"McbXwlF5QGid2OOEpOeBIw",0,"wqHnkeeXSoy1pVKS5B8tNw",0,"_I0-7sBrRMeBAo_m7xWUVw",0,"NOteQck9SCaGu6sUCjcBdg",0,"jnpt3XlkQ62kO2D9SNAv1w",0,"JFK4XVZJRp6mrRCe5cLBXA",0,"QFLF9vV4TDm7PjqFVdAv7A",0,"1medGD73Smqeu-m3vH_rNQ",0,"HPvqDEEyTBSk3OpqI4NYig",0]
    },{
      "function":"__gthc",
      "vtp_trackingId":"UA-165622255-1"
    },{
      "vtp_experimentKey":"OPT-PDS9JV2_OPT-MD78B",
      "function":"__c",
      "vtp_value":true
    },{
      "function":"__exs",
      "vtp_measurementId":"vpWqMn1SSKiD6XBsaD59zA",
      "vtp_sections":["list",2]
    },{
      "vtp_experimentKey":"OPT-PDS9JV2_OPT-MD78B",
      "function":"__c",
      ...
      "function":"__mqp",
      "vtp_url":["template","#",["macro",26]],
      "vtp_targetUrl":["macro",7],
      "vtp_params":["list"]
    },{
      "function":"__mqp",
      "vtp_url":["macro",27],
      "vtp_targetUrl":"https:\/\/www.better5.com\/7-day-core-strengthening",
      "vtp_params":["list"]
    }],
  "tags":[{
      "function":"__asprv",
      ...
      "once_per_load":true,
      "vtp_trackingId":"UA-165622255-1",
      "vtp_hitParams":["map","title","","anonymizeIp","1","nonInteraction",true,"adSenseId",["macro",3],"language",["macro",3],"encoding",["macro",3],"screenColors",["macro",3],"screenResolution",["macro",3],"viewportSize",["macro",3],"flashVersion",["macro",3],"referrer",["macro",3],"location",["macro",3],"hitType","data"],
      ...
      "vtp_activate":true,
      "vtp_isEmpty":false,
      "vtp_treatmentId":"Experiment_OPT-PDS9JV2_OPT-N6L8C:0",
      "vtp_contextIndex":0,
      "tag_id":32
    },{
      "function":"__exsu",
      ...
      "function":"__est",
      "vtp_selector":"a.btn--1604616536037",
      "vtp_identifier":"a.btn--1604616536037",
  ...
  "predicates":[{
      ...
      "function":"_um",
      "arg0":["macro",7],
      "arg1":"https:\/\/www.better5.com\/fit-and-fab-55"
    },{
      "function":"_eq",
      "arg0":["macro",11],
      "arg1":true
      ...
      "function":"_um",
      "arg0":["macro",7],
      "arg1":"https:\/\/static.better5.com\/7-day-core-strength-fast.html"
    },{
      "function":"_eq",
      "arg0":["macro",20],
      "arg1":true
  ...
  "rules":[
    ...
    [["if",1],["add",0]],
    [["if",0],["unless",2],["add",1]],
    [["if",0,4,6],["unless",5],["add",2]],
    [["if",0,4,5],["unless",9],["add",3]],
    [["if",0,10,12],["unless",11],["add",4]],
    [["if",0,4,5,13],["add",5]],
    [["if",0,4,5,14],["add",6]],
    [["if",0,2,10,11,15,16],["add",7]],
    [["if",0,2,10,11,16,17],["add",8]],
    [["if",3],["block",1,2,3,4,5,6,7,8]],
...
var xh=function(a){if(qh[a]||sh)return;var b=F[wh()];xa(b)&&(b("provide",a,wa),qh[a]=!0);},wh=function(){return F.GoogleAnalyticsObject||"ga"},yh=function(a,b){return function(){var c=rh(),d=c&&c.getByName&&c.getByName(a);if(d){var e=d.get("sendHitTask");d.set("sendHitTask",function(f){var h=f.get("hitPayload"),k=f.get("hitCallback"),l=0>h.indexOf("&tid="+b);l&&(f.set("hitPayload",h.replace(/&tid=UA-[0-9]+-[0-9]+/,"&tid="+
...
var bl=function(a,b){var c=a.hide;if(c&&void 0!==c[b]&&c.end){c[b]=!1;var d=!0,e;for(e in c)if(c.hasOwnProperty(e)&&!0===c[e]){d=!1;break}d&&(c.end(),c.end=null)}},fl=function(a){var b=el(),c=b&&b.hide;c&&c.end&&(c[a]=!0)};
var ol=function(){try{var a,b;
var l,n=Yd.B,p=Hd('script[src*="gtm/js?id='+n+'"],script[src*="optimize.js?id='+n+'"]');l=p&&0<p.length?p[0]:null;b=l?l.hasAttribute("async")?"opta":"opts":"optu";b||(b="gaoo");var r=hl(il,l&&l.src),t=r.Mb,q=r.Nb,u=r.wc,v=r.xc,x=r.oc,y=r.Bc,w=r.Eb,A=r.md,z=r.Db;"h0"!=w||jl||(w="h3");kl={Eb:w,Db:z,ah:a,zh:b,md:A,xc:v,oc:x,Bc:y,wc:u,Mb:t,Nb:q,af:ll,
tf:ml};nl(kl)}catch(B){console.log("[opttick] - "+Yd.B+": exception: "+B)}},pl=function(){var a=F.gaData,b=0,c=void 0;if(a)for(var d in a)if(a.hasOwnProperty(d)&&0===d.indexOf("UA-")&&a[d].hitcount){b+=a[d].hitcount;var e=Number(a[d].first_hit);e&&(!c||e<c)&&(c=e)}return{bf:b,Ye:c}},hl=function(a,b){var c,d,e,f,h,k,l,n,p;var r=F.performance;if(r){if(b){var t=r.getEntriesByName(b)[0];if(t){var q=r.getEntriesByType("resource"),u=0;q&&0<q.length&&
(u=q[0].startTime);f=Math.round(t.startTime-u);h=Math.round(t.duration);e=q.indexOf(t);-1===e&&(e=void 0);k=Math.round(a-(t.startTime+t.duration))}}var v=r.timing;if(v.domContentLoadedEventStart){var x=v.domContentLoadedEventStart-v.navigationStart;x&&(d=Math.round(a-x))}var y=r.getEntriesByType("paint").filter(function(B){return"first-contentful-paint"===B.name})[0];y&&(c=Math.round(a-y.startTime))}var w=F["dataLayer"].hide;if(w){if(void 0===w[Yd.B])l="h2";else{var A=!1;if(null===w.end)for(var z in w)if(w.hasOwnProperty(z)&&
z.startsWith(Yd.B)&&!0===w[z]){A=!0;break}l=A?"h0":"h1"}w.start&&!isNaN(w.start)&&(r?r.timing&&(p=Math.round(a+r.timing.navigationStart-w.start)):p=a-w.start);isNaN(w.timeout)||(n=w.timeout)}return{Mb:d,Nb:c,wc:e,xc:f,oc:h,Bc:k,Eb:l,md:n,Db:p}},nl=function(a,b){b=void 0===b?"ol":b;var c=function(e,f){null!=f&&(d+=e+encodeURIComponent(f))},d=he;c("&t=",b);c("&s=",a.Eb);c("&h=",a.Db);c("&g=",a.ah);c("&p=",a.zh);c("&o=",a.md);c("&l=",fe?gl-
Ga(fe):void 0);c("&q=",a.xc);c("&f=",a.oc);c("&e=",a.Bc);c("&i=",a.wc);c("&d=",a.Mb);c("&c=",a.Nb);c("&tr=",a.Yh);c("&jl=",a.xh);c("&jf=",a.vh);c("&ji=",a.wh);c("&jq=",a.yh);c("&jd=",a.th);c("&jx=",a.uh);c("&hc=",a.af);c("&fh=",a.tf);d+="&sr=0.050000";c("&ps=",ql);c("&cb=",Ca());$c(d);},rl=!1,gl,il,jl,ql,kl,ll,ml;ql=Math.random(),rl="0.050000">ql;var sl=function(){
if(!rl||gl)return;gl=La();il=performance&&performance.now()||gl;jl=!!H.querySelector("body");var a=pl(),b=a.Ye;ll=a.bf;ml=b?gl-b:void 0;Rk(ol);},ul=function(a){var b=tl;if(!rl)return;try{var c=La(),d=performance&&performance.now()||c,e=pl(),f=e.bf,h=e.Ye,k=h?c-h:void 0;Rk(function(){var l=hl(d,b),n=l.Mb,p=l.Nb,r=l.wc,t=l.xc,q=l.oc,u=l.Bc,v=l.Eb,x=l.Db,y=m(kl||{});m(a,y);m({Eb:v,Db:x,Mb:n,Nb:p,wh:r,yh:t,th:q,uh:u,af:f,tf:k},y);nl(y,"od")})}catch(l){console.log("[odtick] - "+
Yd.B+": exception: "+l)}};var wl=function(a){if(vl(a))return a;this.h=a};wl.prototype.hh=function(){return this.h};var vl=function(a){return!a||"object"!==$a(a)||bb(a)?!1:"getUntrustedUpdateValue"in a};wl.prototype.getUntrustedUpdateValue=wl.prototype.hh;var xl=[],yl=!1,zl=function(a){return F["dataLayer"].push(a)},Al=function(a){var b=L["dataLayer"],c=b?b.subscribers:1,d=0;return function(){++d===c&&a()}};function Bl(a){var b=a._clear;Fa(a,function(d,e){"_clear"!==d&&(b&&te(d,void 0),te(d,e))});fe||(fe=a["gtm.start"]);sl();var c=a["gtm.uniqueEventId"];if(!a.event)return!1;c||(c=ke(),a["gtm.uniqueEventId"]=c,te("gtm.uniqueEventId",c));return oi(a)}
...
(void 0===F[a]||c&&!F[a])&&(F[a]=b);return F[a]},pm=function(a,b,c){return Le(a,b,void 0===c?!0:!!c)},qm=function(a,b,c){return 0===Ve(a,b,c)},rm=function(a,b){if(vg()){b&&I(b)}else Zc(a,b)},sm=function(a){return!!Nl(a,"init",!1)},tm=function(a){Ll(a,"init",!0)},um=function(a,b){var c=(void 0===b?0:b)?"www.googleoptimize.com/gtag/js":de;c+="?id="+encodeURIComponent(a)+"&l=dataLayer";N(xg("https://","http://",c))},vm=function(a,
b){var c=a[b];return c},wm=function(a,b,c){Wh&&(cb(a)||$h(c,b,a))};
var xm=Gl.Ah;
var ym=function(a){if(!a||a.nodeType!=Node.ELEMENT_NODE)return!1;var b=a.tagName.toUpperCase();return"SCRIPT"==b||"STYLE"==b||"LINK"==b},zm=function(a,b,c){try{null==c?a.removeAttribute(b):a.setAttribute(b,c)}catch(d){return d}return null},Am=function(a,b,c){var d=a.getAttribute(b);return zm(a,b,c)?8:function(){zm(a,b,d)}},Dm=function(a,b,c){var d,e,f=a.ownerDocument||a.document||document;c=(c||"").toLowerCase();"after"==c?(d=a.parentNode,e=a.nextSibling):"insert"==c?(d=a,e=a.firstChild):"append"==
c?(d=a,e=null):(d=a.parentNode,e=a);if(!d||d==f)return{result:1,nh:[]};var h=Bm(b,d);Cm(h,"SCRIPT");Cm(h,"NOSCRIPT");var k=[];if(h.firstChild)for(var l=h.firstChild;l;){var n=l.nextSibling;k.push(l);d.insertBefore(l,e);l=n}var p=a.nextSibling;"replace"==c&&d.removeChild(a);return{result:function(){for(;0<k.length;)d.removeChild(k.pop());"replace"==c&&d.insertBefore(a,p)},nh:k.slice()}},Em={SELECT:[1,'<select multiple="multiple">',"</select>"],FIELDSET:[1,"<fieldset>","</fieldset>"],MAP:[1,"<map>",
"</map>"],OBJECT:[1,"<object>","</object>"],TABLE:[1,"<table>","</table>"],TBODY:[2,"<table><tbody>","</tbody></table>"],COLGROUP:[2,"<table><colgroup>","</colgroup></table>"],TR:[3,"<table><tbody><tr>","</tr></tbody></table>"]},Bm=function(a,b){var c=0,d="",e="",f=Em[b.tagName];null!=f&&(c=f[0],d=f[1],e=f[2]);var h=b.ownerDocument.createElement("div");Rc(h,Sc(d+(a||"")+e));for(var k=h;0<c;){var l=k.firstChild;if(null==l.firstChild)return b.ownerDocument.createElement("div");k=l;c--}return k},Cm=
function(a,b){for(var c=a.getElementsByTagName(b),d=[],e=c.length-1;0<=e;e--){var f=c[e];f.parentNode.removeChild(f);d.push(f)}},Fm=function(a){var b=null,c=null;try{b=new Function("element",a)}catch(d){c=d}return{jd:b,error:c}},Jm=function(a,b,c,d,e){var f=a+"{"+(b+": "+c+(d?" !important":""))+"}";e&&(f=e+"{"+f+"}");var h=document;if(h.createStyleSheet){var k=Gm(h),l=k.rules.length;k.insertRule(f,l);return function(){k.deleteRule?k.deleteRule(l):k.removeRule(l);k.insertRule("x {}",l)}}var n=Hm(f,
h);Im(n,h);var p=n.parentNode;return function(){p.removeChild(n)}},Km=null,Gm=function(a){if(Km)return Km;for(var b=a.styleSheets.length-1;0<=b;b--){var c=a.styleSheets[b];if(!c.href){var d=c.ownerNode;if(d&&d.parentNode&&"HEAD"==d.parentNode.tagName)return Km=c}}0==a.styleSheets.length&&a.createStyleSheet();return Km=a.styleSheets[0]},Hm=function(a,b){var c=(b||document).createElement("style");void 0!==c.cssText?c.cssText=a:c.innerHTML=a;return c},Im=function(a,b){var c=b||document,d=c.getElementsByTagName("head")[0];
d||(d=c.createElement("head"),c.body.parentNode.insertBefore(d,c.body));d.appendChild(a)},Lm=function(a,b,c,d){if(a.style.setProperty)try{var e=a.style.getPropertyValue(b),f=a.style.getPropertyPriority(b);a.style.setProperty(b,c,d?"important":"");return function(){a.style.setProperty(b,"",f);a.style.setProperty(b,e,f)}}catch(k){}var h=a.style.cssText;a.style.cssText+=";"+(b+": "+c+(d?" !important":""))+";";return function(){a.style.cssText=h}},Nm=function(a,b,c,d){if(ym(a))return 7;if(b)return Mm(a,
b,d);if(c&&c.parentNode){var e=a.parentNode,f=a.nextSibling;try{c.parentNode.insertBefore(a,c.nextSibling)}catch(h){return 9}return function(){e.insertBefore(a,f)}}return 4},Mm=function(a,b,c){var d=a.parentNode,e=a.nextSibling;c=(c||"").toLowerCase();try{if("bottom"==c)b.appendChild(a);else if("top"==c)b.insertBefore(a,b.childNodes[0]||null);else if("before"==c)if(b.parentNode)b.parentNode.insertBefore(a,b);else return 5;else if("after"==c)if(b.parentNode)b.parentNode.insertBefore(a,b.nextSibling);
else return 5}catch(f){return 9}return function(){try{d.insertBefore(a,e)}catch(f){}}},Om=function(a,b,c){if(0<=b&&b<a.childNodes.length){var d=a.childNodes[b];if(null!=d&&d.nodeType==Node.TEXT_NODE){var e=d.nodeValue;d.nodeValue=c;return function(){d.nodeValue=e}}return 2}return 3},Pm=function(a,b,c,d){c?d=c.nextSibling:d&&(c=d.previousSibling);if(null!=c&&c.nodeType==Node.TEXT_NODE){var e=c.nodeValue;c.nodeValue+=a;return function(){c.nodeValue=e}}if(null!=d&&d.nodeType==Node.TEXT_NODE){var f=d.nodeValue;
d.nodeValue=a+d.nodeValue;return function(){d.nodeValue=f}}var h=(b.ownerDocument||b.document||document).createTextNode(a);d?b.insertBefore(h,d):b.appendChild(h);return function(){b.removeChild(h)}},Qm=function(a){var b=document.createElement("a");a&&(b.href=a);return b};function Um(a,b){a=String(a);b=String(b);var c=a.length-b.length;return 0<=c&&a.indexOf(b,c)==c}var Vm=new Da;function Wm(a,b){function c(h){var k=He(h),l=Fe(k,"protocol"),n=Fe(k,"host",!0),p=Fe(k,"port"),r=Fe(k,"path").toLowerCase().replace(/\/$/,"");if(void 0===l||"http"==l&&"80"==p||"https"==l&&"443"==p)l="web",p="default";return[l,n,p,r]}for(var d=c(String(a)),e=c(String(b)),f=0;f<d.length;f++)if(d[f]!==e[f])return!1;return!0}
...
var cn=function(a,b,c){for(var d={},e=!1,f=0;a&&f<a.length;f++)a[f]&&a[f].hasOwnProperty(b)&&a[f].hasOwnProperty(c)&&(d[a[f][b]]=a[f][c],e=!0);return e?d:null};Zm.qh=function(){var a=!1;return a};var fn=function(a){if(!dn[a]){dn[a]=!0;var b=F[a]||{};F[a]=b;var c=function(e){return en[e]},d=b.get;b.get=d?function(e){return void 0!==en[e]?en[e]:d(e)}:c}},gn=function(a,b,c){try{a(c,b,Yd.B)}catch(d){}},jn=function(a){hn[a]=hn[a]||[];return hn[a]},en={},hn={},dn={};
var kn=function(){F.gaData=F.gaData||{};return F.gaData},ln=function(a,b){b=void 0===b?!1:b;F.gaData=F.gaData||{};var c=F.gaData,d=c.tracker_created;c.tracker_created=function(e){b&&a(e);d&&xa(d)&&d(e);b||a(e)}},mn=function(a){var b=F[wh()];try{if(xa(b)&&xa(b.getAll))return Ba(b.getAll(),function(c){return c.get("trackingId")===a})}catch(c){console.log("Optimize: GA Exception "+c+" trackingId: "+a+" exception: "+c)}},sn=function(a,b){var c=nn[a];if(c)I(function(){return b(c)});else{var d=mn(a);d?
(nn[a]=d,on||(on=d),I(function(){return b(d)})):(pn[a]||(pn[a]=[]),pn[a].push(b),qn||(qn=!0,ln(function(e){var f=e.get("trackingId");if(pn[f]){if(rn[f]){rn[f]=!1;var h=F[wh()];xa(h)&&h("ga.require","_"+Yd.B)}on||(on=e);nn[f]=e;for(var k=pn[f],l;void 0!==(l=k.shift());)l(e);pn[f]=void 0}})))}},tn=function(a,b,c,d){var e=F[wh()];if("data"===b.hitType&&c){var f=F.gaData,h=Number(f&&f[d]&&f[d].first_hit),k=La();!isNaN(h)&&k>h&&(b.queueTime=Math.min(2E3,k+100-h))}try{var l="t0"!=a.get("name")?a.get("name")+
".send":"send";e(l,b)}catch(n){console.log("Optimize: failed to send hit using tracker: "+a.name+" exception "+n)}},nn={},pn={},rn={},on,qn=!1,un=function(a,b,c){sn(a,function(d){I(function(){tn(d,b,c,a)})})},vn=function(){var a=!1;ln(function(){if(!a){var b=F[wh()];xa(b)&&(b("ga.require","__"+Yd.B),a=!0)}},!0)},wn=function(a,b,c){var d=kn(),e=d[a]=d[a]||{};(e.pending_experiments=e.pending_experiments||{})[b]=c;e.experiments=e.experiments||{};e.experiments[b]=c},xn=function(a){var b=kn()[a];return b?
b.hitcount||0:0},yn=function(a,b,c,d){if(d){var e=Ee(F.location,"host");Ee(He(d),"host")===e&&(d="")}wn(a,b,c);ln(function(h){h.set("referrer",d?d:void 0)},!0);if(0<xn(a)){var f=mn(a);f&&(f.set("referrer",d?d:void 0),tn(f,{hitType:"data"},!0,a))}};
var Cn=function(a,b,c){function d(){f||(f=!0,!0!==zn&&(zn=!1),An(c),bl(el(),e))}tl=a;var e="OPT-PDS9JV2_"+b,f=!1;fl(e);F.google_optimize=F.google_optimize||{};var h=F.google_optimize;h["OPT-PDS9JV2"]=h["OPT-PDS9JV2"]||{};h["OPT-PDS9JV2"].optimize_dyn=function(l){l.split(",").forEach(function(n){Bn[n]=!0});zn=!0;d()};Xc(a,void 0,d);var k=el();F.setTimeout(function(){d()},Number(k&&k.hide&&k.hide.timeout)||1E4)},An=function(a){if(void 0!==Dn){var b=Dn-En,c,d;zn?c=La()-Dn:d=La()-Dn;ul({Yh:b,xh:c,vh:d})}Bn.optimize_ready=
!0;zl({event:"opt.dyn"});zl({event:"opt.js"});if(a&&0<a.length){var e={};el().forEach(function(f){var h=f.event;h&&(e[h]=!0)});a.forEach(function(f){e[f]&&zl({event:f})})}I(function(){xh("_"+Yd.B)})},el=function(){return F["dataLayer"]},Fn=function(a,b,c,d,e,f,h){function k(q,u){u&&(r+="&"+q+"="+encodeURIComponent(u))}En=La();if(a||b||c){var l=void 0;if(b){var n=$f().aw;n&&(l=n[0])}if(f&&(a||c||l)){var p=1,r,t="OPT-PDS9JV2_"+p++;fl(t);rn[d]=!0;sn(d,function(q){Dn=La();a||b?(r="https://www.google-analytics.com/gtm/optimize-dyn.js?id=OPT-PDS9JV2",
a&&k("cid",q.get("clientId")),k("gclid",l),h&&(k("gtm_auth",""),k("gtm_preview","")),(h||a)&&k("cb",String(Math.random())),Cn(r,p++,e)):An(e);bl(el(),t)})}else An(e)}},Bn={},En,Dn,zn,tl;var Gn=function(a,b){this.mc=a;this.Ib=b};Gn.prototype.toString=function(){var a=""+this.mc;1<this.Ib&&(a=a+"-"+this.Ib);return a};var Hn=function(a,b){this.i=a;this.h=b};Hn.prototype.toString=function(){return this.h+"."+this.i};
var In=function(){var a=qe("optimize.cookie_path",2);return g(a)?a:"/"},Kn=function(a,b){var c=new Jn(a,b);c.Eh();return c},Jn=function(a,b){this.L=Math.floor(new Date/864E5);this.i=a||"auto";this.h=b||In();this.o=new Gn(Ze(this.i),$e(this.h));this.C=[];this.map={}};aa=Jn.prototype;aa.gh=function(a){if(!a)return"";var b=this.kd(a);return b?b.i:""};aa.Rh=function(a,b,c,d,e){var f,h;f=void 0===f?10:f;h=void 0===h?3E3:h;if(!a)return!1;void 0==b&&(b="");this.zc(a,new Hn(b,c));this.zg(e);return this.Bh(d,
f,h)};aa.kd=function(a){return this.map[a]};aa.eh=function(){for(var a=0,b=0;b<this.C.length;b++)"x"!==this.kd(this.C[b]).i[0]&&a++;return a};aa.zc=function(a,b){a&&(""===b.i?this.lf(a):(this.map[a]||this.C.push(a),this.map[a]=b))};aa.Th=function(a){for(var b=0;b<a.length;b++)this.zc(a[b][0],a[b][1])};aa.lf=function(a){var b=Aa(this.C,a);0<=b&&this.C.splice(b,1);delete this.map[a]};aa.Lh=function(){for(var a=[],b=0;b<this.C.length;b++){var c=this.C[b];this.map[c].h<this.L&&a.push(c)}for(var d=0;d<
a.length;d++)this.lf(a[d])};aa.dh=function(){for(var a=[],b=0;b<this.C.length;b++){var c=this.C[b];a.push([c,this.map[c]])}return a};aa.Wg=function(){for(var a=0,b=0;b<this.C.length;b++)a=Math.max(a,this.map[this.C[b]].h);return 864E5*a};aa.toString=function(){if(0==this.C.length)return"";for(var a=[],b=0;b<this.C.length;b++){var c=this.C[b];a.push(c+"."+this.map[c].toString())}return"GAX1."+this.o.toString()+"."+a.join("!")};aa.Bh=function(a,b,c){var d=new Date;this.Lh();var e=this.eh();if(e>b||
e>(a||10)&&document.cookie.replace(/(?:;\s*)?(_gaexp=[^;]+)(?:;\s*)?/,this.toString()).length>c)return!1;d.setTime(this.Wg());if("auto"!=this.i)return this.o=new Gn(Ze(this.i),$e(this.h)),0===Ve("_gaexp",this.toString(),{path:this.h,domain:this.i,expires:d});for(var f=Se(),h=0;h<f.length;h++)if(this.o=new Gn(Ze(f[h]),$e(this.h)),0===Ve("_gaexp",this.toString(),{path:this.h,domain:f[h],expires:d}))return!0;return!1};aa.Eh=function(){var a=Oe("_gaexp",this.o.mc,this.o.Ib);if(a){var b=this.Fh(a);b&&
this.Th(b.dh())}};aa.Fh=function(a){for(var b=new Jn(this.i,this.h),c=a.split("!"),d=0;d<c.length;d++){var e=c[d].split(".");if(3==e.length){if(isNaN(Number(e[1])))return;b.zc(e[0],new Hn(e[2],Number(e[1])))}}return b};aa.zg=function(a){a=a||{};var b=0;a.hasOwnProperty("")&&!isNaN(Number(a[""]))&&(b=this.L-Ga(a[""]));for(var c=0;c<this.C.length;c++){var d=this.C[c];if(a.hasOwnProperty(d)&&!isNaN(Number(a[d]))){var e=this.kd(d);e.h=Ga(a[d])+b;this.zc(d,e)}}};
var Ln=function(a){try{return Hd(a)}catch(b){return null}},Mn=function(a){if(Zg)return!0;for(;a;){if(a.nextSibling)return!0;a=a.parentNode}return!1},Nn=function(a,b){for(var c=Ln(a.O)||[],d=[],e=0;e<c.length;e++){var f=c[e];if(!f.gtmProgressiveApplied||!f.gtmProgressiveApplied[b]){if(a.U&&!Mn(f))break;d.push(f)}}return d},On=function(a,b){return function(){a.gtmProgressiveApplied&&delete a.gtmProgressiveApplied[b]}},Pn=function(a,b){a.gtmProgressiveApplied||(a.gtmProgressiveApplied={});a.gtmProgressiveApplied[b]=
!0},Qn=function(a,b){var c;var d=[];if(b.Z)if(b.Z.fd)c=[{element:H.head}];else{var e=Nn(b.Z,b.id),f=null;b.Ac&&(f=Nn(b.Ac,b.id+"-t"));for(var h=0;h<e.length;h++){var k=e[h],l=void 0;if(null!=f&&(l=f.length>h?f[h]:null,!l&&!Zg&&(null===b.Ac.N||b.Re+d.length<b.Ac.N)))break;d.push({element:k,Xh:l})}c=d}else c=d;var n=c;if(!Zg&&b.sg&&(!a||null==b.Z.N||b.Z.N!=b.ed+n.length))return!1;for(var p=0;p<n.length;p++){var r=n[p].element,t=n[p].Xh,q=void 0;b.ed++;Pn(r,b.id);t&&(b.Re++,q=b.id+"-t",Pn(t,q));var u=
b.Ag(r,t);xa(u)&&b.Ya.push(u);b.Ya.push(On(r,b.id));t&&q&&b.Ya.push(On(t,q))}if(b.Z.N&&b.Z.N==b.ed||Zg)b.finished=!0;return!0},Rn=function(a){for(var b={},c=0;c<a.X.length;c++){var d=a.X[c];if(!d.Z.fd){var e=b[d.Z.O];e||(e=b[d.Z.O]=Ln(d.Z.O)||[]);for(var f=0;f<e.length;f++){var h=e[f];h.gtmProgressiveApplied&&h.gtmProgressiveApplied[d.id]||(Pn(h,d.id),d.Ya.push(On(h,d.id)))}}}},Sn=function(a){if(!a.Ed){for(var b=a.Cb;b<a.X.length;b++){var c=a.X[b],d=b==a.Cb;if(!c.finished&&!Qn(d,c))break;c.finished&&
d&&a.Cb++}a.X.length>a.Cb?(a.Ba||(a.Ba=F.setTimeout(function(){a.Ba=null;Sn(a)},80)),Zg||a.vd||(a.vd=function(){I(function(){Sn(a)})},ad(H,"DOMContentLoaded",a.vd))):Rn(a)}},Tn={},Un={},Vn=void 0,Wn=function(a,b,c,d){var e=Vn;if(!Gd||!e)return!1;var f={id:e.id+":"+e.X.length,Ag:b,Ya:[],sg:c,Z:a,ed:0,Ac:d||null,Re:0,finished:!1};e.X.push(f);null===a?(f.finished=!0,b(null)):Sn(e);return!0},Xn=function(a){var b=wa;try{b=Jm(a,"visibility","hidden",!0)}catch(c){}return function(){xa(b)&&b.apply();b=null}},
Yn=function(a,b,c,d){var e=b;if(!Zg&&!a.fd){var f=Xn(a.O);ah.push(f);e=function(h,k){var l=b(h,k);f();return l}}return Wn(a,e,c,d)};var Zn=function(a){return a.href.replace("?&","?").replace(/(\?|&)#/,"#").replace(/(\?|&)$/,"")};function no(){return F.gaGlobal=F.gaGlobal||{}}var oo=function(){var a=no();a.hid=a.hid||Ca();return a.hid},po=function(a,b){var c=no();if(void 0==c.vid||b&&!c.from_cookie)c.vid=a,c.from_cookie=b};var To=window,Uo=document,Vo=function(a){var b=To._gaUserPrefs;if(b&&b.ioo&&b.ioo()||a&&!0===To["ga-disable-"+a])return!0;try{var c=To.external;if(c&&c._gaUserPrefs&&"oo"==c._gaUserPrefs)return!0}catch(f){}for(var d=Je("AMP_TOKEN",String(Uo.cookie),!0),e=0;e<d.length;e++)if("$OPT_OUT"==d[e])return!0;return Uo.getElementById("__gaOptOutExtension")?!0:!1};function Yo(a){delete a.eventModel[C.wb];$o(a.eventModel)}var $o=function(a){Fa(a,function(c){"_"===c.charAt(0)&&delete a[c]});var b=a[C.la]||{};Fa(b,function(c){"_"===c.charAt(0)&&delete b[c]})};var cp=function(a,b,c){Fk(b,c,a)},dp=function(a,b,c){Fk(b,c,a,!0)},gp=function(a,b){};
function fp(a,b){}var Y={a:{}};
Y.a.pr=["google"],function(){(function(a){Y.__pr=a;Y.__pr.b="pr";Y.__pr.g=!0;Y.__pr.priorityOverride=0})(function(a){var b=a.vtp_targetUrl,c=Ga(a.vtp_interval||1E4),d=Ga(a.vtp_max||2),e=a.vtp_measurementId,f=a.vtp_variantId;if(b)if(2048<b.length)a.vtp_gtmOnFailure();else{for(var h=new Date(im().getTime()+c),k=0,l=pm("_gaexp_rc"),n=0;n<l.length;n++)k=Math.max(k,Ga(l[n]));k++;if(qm("_gaexp_rc",String(k),{path:In(),domain:"auto",expires:h})&&k<=d){if(void 0!==e&&void 0!==f){var p=H.referrer||"";p&&(p=
p.replace(/(\?|#).*$/,""));var r=new Date(im().getTime()+1E4);qm("_opt_expid",e+"$"+f+"$"+p,{path:In(),domain:"auto",expires:r,encode:!0})}sh=!0;vn();var t=V("document"),q=t.documentElement;q&&(q.style.display="none");var u=lm(jm()),v=lm(b);t.location.replace(b);u===v&&t.location.reload();a.vtp_gtmOnSuccess()}else a.vtp_gtmOnFailure()}else a.vtp_gtmOnFailure()})}();
...
Y.a.exs=["google"],function(){(function(a){Y.__exs=a;Y.__exs.b="exs";Y.__exs.g=!0;Y.__exs.priorityOverride=0})(function(a){var b=Kn(a.vtp_cookieDomain,a.vtp_cookiePath).gh(a.vtp_measurementId);if(""===b)return b;if("x"===b[0]){var c=Number(b.substring(1));if("x"===b||isNaN(c)||0>c||1E3<=c)return""}else{var d=a.vtp_sections;if(d){var e=b.split("-");if(d.length!=e.length)return"";for(var f=0;f<d.length;f++)if(0>e[f]||e[f]>=d[f])return""}}return b})}();Y.a.optua=["google"],function(){(function(a){Y.__optua=a;Y.__optua.b="optua";Y.__optua.g=!0;Y.__optua.priorityOverride=0})(function(a){un(a.vtp_trackingId,a.vtp_hitParams,a.vtp_correctDataHit);a.vtp_gtmOnSuccess()})}();

Y.a.sel=["google"],function(){(function(a){Y.__sel=a;Y.__sel.b="sel";Y.__sel.g=!0;Y.__sel.priorityOverride=0})(function(a){return Hd(a.vtp_selector)})}();
...
Y.a.e=["google"],function(){(function(a){Y.__e=a;Y.__e.b="e";Y.__e.g=!0;Y.__e.priorityOverride=0})(function(a){return String(ve(a.vtp_gtmEventId,"event"))})}();Y.a.k=["google"],function(){(function(a){Y.__k=a;Y.__k.b="k";Y.__k.g=!0;Y.__k.priorityOverride=0})(function(a){return pm(a.vtp_name,mm("gtm.cookie",1),!!a.vtp_decodeCookie)[0]})}();
...
Y.a.exsu=["google"],function(){(function(a){Y.__exsu=a;Y.__exsu.b="exsu";Y.__exsu.g=!0;Y.__exsu.priorityOverride=0})(function(a){Kn(a.vtp_cookieDomain,a.vtp_cookiePath).Rh(a.vtp_measurementId,a.vtp_newState,a.vtp_expirationDay,a.vtp_max,a.vtp_expirationDates)?a.vtp_gtmOnSuccess():a.vtp_gtmOnFailure()})}();
Y.a.ctto=["google"],function(){(function(a){Y.__ctto=a;Y.__ctto.b="ctto";Y.__ctto.g=!0;Y.__ctto.priorityOverride=0})(function(a){var b=a.vtp_isDynamic,c=V("dataLayer"),d=c&&c.hide;if(!d)return!1;var e=Yd.B,f=V("document");if(void 0===f.querySelector)return!1;var h=!!f.querySelector("body");if(null!==d.end||!h)return!1;if(!b)return!0===d[e];for(var k in d)if(d.hasOwnProperty(k)&&k.startsWith(e)&&!0===d[k])return!0;return!1})}();
Y.a.dr=["google"],function(){(function(a){Y.__dr=a;Y.__dr.b="dr";Y.__dr.g=!0;Y.__dr.priorityOverride=0})(function(a){var b=a.vtp_treatmentId,c=a.vtp_activate,d=a.vtp_contentSignature,e=a.vtp_isEmpty,f=mm("optimize.experimentCallback",1),h=a.vtp_measurementId,k=a.vtp_experimentCombination,l;if(l=c){var n=Tn[h];l=!(!n||n==b)}if(l)a.vtp_gtmOnFailure();else{var p=mm("optimize.whitelist",1);if(p&&p[h]?p[h]===d:Sg()?e:1){if(xa(f)){var r={xid:h,xvar:k,activate:c};try{f(r)}catch(O){}}var t=!1,q=!0;if(c){var u;
Tn[h]=b;var v=Un[b];if(v){for(var x=v.Cb=0;x<v.X.length;x++)v.X[x].finished=!1;Sn(v);u=!0}else u=!1;if(u)t=!0;else{var y=Un[b];y||(y={id:b,X:[],Cb:0,Ba:null,vd:void 0,Ed:!1},Un[b]=y);Vn=y}}else{var w=Un[b];if(!w||w.Ed)q=!1;else{for(;w.X.length;)for(var A=w.X.pop();A.Ya.length;){var z=A.Ya.pop();if(xa(z))try{z()}catch(O){}}w.Ed=!0;delete Un[b];q=!0}}if(q){var B=c?k:void 0;en[h]=B;for(var E=jn(h),G=0;G<E.length;G++)gn(E[G],h,B);E=jn("");for(var M=0;M<E.length;M++)gn(E[M],h,B)}a[t?"vtp_gtmOnFailure":
...
Y.a.reimp=["google"],function(){(function(a){Y.__reimp=a;Y.__reimp.b="reimp";Y.__reimp.g=!0;Y.__reimp.priorityOverride=0})(function(a){var b=a.vtp_trackingId,c=a.vtp_live,d=a.vtp_impressionCookie||"";if(d){var e=In();Ue("_opt_expid",void 0,{domain:"auto",path:e});var f=d.split("$");if(3!==f.length)a.vtp_gtmOnFailure();else{var h=f[0],k=f[1],l=f[2];c&&yn(b,h,k,l);a.vtp_gtmOnSuccess()}}else a.vtp_gtmOnFailure()})}();
Y.a.asprv=["google"],function(){(function(a){Y.__asprv=a;Y.__asprv.b="asprv";Y.__asprv.g=!0;Y.__asprv.priorityOverride=0})(function(a){var b=a.vtp_globalName,c=mm("eventModel");b&&fn(b);var d,e,f;c&&(d=c.name||"",e=c.callback,f=c.remove);if(e&&xa(e))if(d=String(d),!0!==f){var h=d,k=e;jn(h).push(k);if(""!==h)void 0!==en[h]&&gn(k,h,en[h]);else for(var l in en)void 0!==en[l]&&gn(k,l,en[l])}else{var n=e,p=jn(d),r=p.indexOf(n);0<=r&&p.splice(r,1)}a.vtp_gtmOnSuccess()})}();
...
Y.a.mqp=["google"],function(){(function(a){Y.__mqp=a;Y.__mqp.b="mqp";Y.__mqp.g=!0;Y.__mqp.priorityOverride=0})(function(a){var b=a.vtp_url||"",c=a.vtp_targetUrl;if(!c)return b;for(var d=a.vtp_max||2048,e=a.vtp_params||[],f=Qm(b),h=Qm(c),k,l=f.search,n=h.search.replace("?","").split("&"),p=l.replace("?","").split("&"),r={},t=[],q=0;q<n.length;q++)r[n[q].split("=")[0]]=!0,t.push(n[q]);for(var u=0;u<p.length;u++)r[p[u].split("=")[0]]||t.push(p[u]);k=t.join("&");h.search=0<k.length?"?"+k:"";var v,x=f.hash;
v=h.hash.replace("#","")||x.replace("#","");0<v.length&&(h.hash=v);for(var y=0;y<e.length&&!(Zn(h).length<=d);y++){for(var w=e[y],A=w[0],z=Ha(w[1]),B=Zn(h).length,E=h.search.replace("?","").split("&"),G=[],M=0;M<E.length;M++){var O=E[M].split("=");if(O[0]===A)if(!z||2>O.length)G.push(M);else{for(var W=O[1],Z=W;B-W.length+Z.length>d&&""!==Z;){var ca=encodeURIComponent,J;var K=decodeURIComponent(Z),P=K.indexOf("#");if(0<P)J=K.substring(0,P);else if(P=K.indexOf("?"),0<P)J=K.substring(0,P);else{var S=
K.indexOf("//");P=0>S?K.indexOf("/"):K.indexOf("/",S+2);J=0<P?K.substring(0,P):""}Z=ca(J)}""===Z?G.push(M):(O[1]=Z,E[M]=O.join("="))}}for(var T=G.length-1;0<=T;T--)E.splice(G[T],1);var na=E.join("&");h.search=0<na.length?"?"+na:""}return Zn(h)})}();
...
Y.a.est=["customScripts"],function(){(function(a){Y.__est=a;Y.__est.b="est";Y.__est.g=!0;Y.__est.priorityOverride=0})(function(a){var b=a.vtp_property,c=a.vtp_value,d=a.vtp_important,e=a.vtp_selector,f=a.vtp_identifier,h=a.vtp_cssConditional;if(Gd)if(Vn){var k,l;if(a.vtp_cssRule){var n=Jm(e,b,c,d,h);l=Wn({O:"body",U:!1,N:1},function(){xa(n)&&n.apply();n=null;return Jm(e,b,c,d,h)},!1)}else{var p={O:e,U:!1,N:e==f?1:null};k=function(r){if(r)return Lm(r,b,c,d)};l=Yn(p,k,!1)}l?a.vtp_gtmOnSuccess():a.vtp_gtmOnFailure()}else a.vtp_gtmOnFailure();
else a.vtp_gtmOnFailure()})}();
...
!0;try{q=!F.frameElement}catch(w){}q&&ch()}ad(F,"load",bh)}Ok=!1;"complete"===H.readyState?Qk():ad(F,"load",Qk);a:{if(!Wh)break a;F.setInterval(Xh,864E5);}zl({event:"gtm.js"});ge=(new Date).getTime();}}
(function(a){var e=!0;
e=!1;e=!0;if(e){a();return}var f=function(){var n=F["google.tagmanager.debugui2.queue"];n||(n=[],F["google.tagmanager.debugui2.queue"]=n,Xc("https://www.googleoptimize.com/debug/bootstrap"));return n},h="x"===Fe(F.location,"query",
